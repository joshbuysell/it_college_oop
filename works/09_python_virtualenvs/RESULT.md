# Звіт до роботи
## Тема: Віртуальні середовища Python
### Мета роботи: Навчитися працювати зі сторонніми бібліотеками, створювати та використовувати віртуальні середовища (venv, pipenv, poetry), управляти залежностями та змінними середовища.
