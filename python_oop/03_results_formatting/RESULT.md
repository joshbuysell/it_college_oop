...
## Як відтворити
```bash
python3 python_oop/03_results_formatting/src/hello.py
python3 python_oop/03_results_formatting/src/my_first_app.py
```

## Додатково
- Для перегляду ноутбука: `python_oop/03_results_formatting/my_first_app_chatgpt.ipynb`
